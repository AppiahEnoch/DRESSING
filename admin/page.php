...
<html lang="en">
  <head>
    ...
    <title>Admin| The Dressing</title>
    <link
    ...
    <?php echo filemtime("./addProduct.css"); ?>
    " />
    <link rel="stylesheet" href="./addAdmin.css?
    <?php echo filemtime("./addAdmin.css"); ?>
    " />
...
?>
    ...
    <script src="addProduct.js?version=<?php echo filemtime('addProduct.js'); ?>"></script>
    <script src="category.js?version=<?php echo filemtime('category.js'); ?>"></script> 
    <script src="removeProduct.js?version=<?php echo filemtime('removeProduct.js'); ?>"></script>  
    <script src="addAdmin.js?version=<?php echo filemtime('addAdmin.js'); ?>"></script>    
  </body>
</html>
